...
$whereParts = ['LevelID = 1', 'is_published = 1'];
$params = [];
...
<div class="container my-5 pt-5">
    <h1 class="text-center mb-5">Undergraduate Programmes</h1>

    <form method="GET" class="mb-5">
        <div class="input-group">
            <input type="text" name="search" class="form-control" placeholder="Search undergraduate programmes..." value="<?= htmlspecialchars($search) ?>">
            <button type="submit" class="btn btn-primary">Search</button>
        </div>
    </form>

    <?php if (empty($programmes)): ?>
        <div class="alert alert-info text-center">No undergraduate programmes match your search.</div>
    <?php else: ?>
        <div class="row g-4">
